...
/**
 * The interface {@code FormatIfEnabledConsumer} defines the behavior of objects that consume the results of
 * an {@code edit.formatIfEnabled} request.
 */
public interface FormatIfEnabledConsumer extends Consumer {
  /**
